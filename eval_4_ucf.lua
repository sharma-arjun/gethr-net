...
if string.len(opt.init_from) > 0 then
    ...
    print('overwriting rnn_size_vid=' .. checkpoint.opt.rnn_size_vid .. ', num_layers_vid=' .. checkpoint.opt.num_layers_vid .. ' based on the checkpoint.')
    opt.rnn_size_vid = checkpoint.opt.rnn_size_vid
    opt.num_layers_vid = checkpoint.opt.num_layers_vid
    opt.rnn_size_aud = checkpoint.opt.rnn_size_aud
    opt.num_layers_aud = checkpoint.opt.num_layers_aud
    opt.rnn_size_comb = checkpoint.opt.rnn_size_comb
    opt.num_layers_comb = checkpoint.opt.num_layers_comb
    opt.reduced_size = checkpoint.opt.reduced_size
...
local  all_predictions = eval_split(phase) -- 2 = validation
matio.save('proposed5_490_384_490_768_1_1_1.mat',{t1=all_predictions})
