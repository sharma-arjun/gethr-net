...
local LSTM4 = {}
function LSTM4.lstm(input_size_vid, input_size_aud, output_size, rnn_size_vid, rnn_size_aud, rnn_size_comb, n_vid, n_aud, n_comb, reduced_size, dropout)
  ...
  for L = 1,n_comb do
    ...
    if L == 1 then
      ...
      x_comb = nn.Linear(rnn_size_vid + rnn_size_aud, reduced_size)(x_comb)
