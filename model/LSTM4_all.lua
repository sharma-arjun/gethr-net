...
local LSTM4_all = {}
function LSTM4_all.lstm(input_size_vid1, input_size_vid2, input_size_aud, output_size, rnn_size_vid1, rnn_size_vid2, rnn_size_aud, rnn_size_comb, n_vid1, n_vid2, n_aud, n_comb, reduced_size, dropout)
  ...
  for L = 1,n_comb do
    ...
    if L == 1 then
      ...
      x_comb = nn.Linear(rnn_size_vid1 + rnn_size_vid2 + rnn_size_aud, reduced_size)(x_comb)
      x_comb = nn.Sigmoid()(x_comb)
      input_size_L_comb = reduced_size
    else
